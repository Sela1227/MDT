...
# 5. zip 檔名 = 版本號
# 6. 版本號命名規則（嚴格遵守）：
#    bug fix / hotfix      → +0.01  （如 V4.2.10 → V4.2.10）
#    新功能 / 新欄位       → +0.1   （如 V4.2.10 → V4.2.10）
#    大改版 / 架構重構     → +1.0   （如 V4.2.10 → V4.2.10）
...
| 版本 | 關鍵變更 |
|------|---------|
| V4.2.10 | 還原 extraJs 為 backtick template literal；僅移除 Ctrl+S 的 S.meeting 引用 |
