...
# 5. zip 檔名 = 版本號
# 6. 版本號命名規則（嚴格遵守）：
#    bug fix / hotfix      → +0.01  （如 V3.2.10 → V3.2.10）
#    新功能 / 新欄位       → +0.1   （如 V3.2.10 → V3.2.10）
#    大改版 / 架構重構     → +1.0   （如 V3.2.10 → V4.0.0）
...
| 版本 | 關鍵變更 |
|------|---------|
| V3.2.10 | LINE通知移除診斷；HTML投影片診斷字放大；topics固定順序（影像/病理/分期/治療策略）|
